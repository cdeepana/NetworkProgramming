        ...
        if (smtpSocket != null && out != null && in != null) {
            try {
                ...
                */
                ...
                out.println("MAIL From: networkchathura@gmail.com");
                while ((responseLine = in.readLine()) != null) {
                    System.out.println("Server: " + responseLine);
                    if (responseLine.indexOf("250") != -1) {
                        break;
                ...
                */
                ...
                out.println("RCPT TO: yuzekiv@royalhost.info");
                ...
                */
                ...
                out.println("From: networkchathura@gmail.com");
                out.println("To: yuzekiv@royalhost.info");
